  ...
  return (
    <main className="max-w-2xl mx-auto fade-in">
      ...
      <section className="mb-10">
        ...
        <div className="mb-6">
          <div className="flex justify-between">
            <p className="font-medium">Software Engineer Intern — MascotGO</p>
            <p className="text-gray-500 text-sm">Feb. 2026 - Aug. 2026</p>
          </div>
          <p className="text-gray-500 text-sm mb-2">Remote</p>
        ...
        <div>
          <div className="flex justify-between">
            <p className="font-medium">Mentor — ReDesignHer</p>
            <p className="text-gray-500 text-sm">Feb. 2026 - Mar. 2026</p>
          </div>
          <p className="text-gray-500 text-sm mb-2">Remote</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1">
      ...
      <section className="mb-10">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm mb-2">Python, Flask, Backboard AI, HTML/CSS</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1">
        ...
        <div className="mb-6">
          <p className="font-medium">School Planner</p>
          <p className="text-gray-500 text-sm mb-2">Python, Tkinter, SQLite</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1">
        ...
        <div>
          <p className="font-medium">Text-Based Adventure Game</p>
          <p className="text-gray-500 text-sm mb-2">Python</p>
          <ul className="list-disc list-inside text-gray-600 space-y-1">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600">AI Fundamentals: Foundations for Understanding AI from IBM</p>
      </section>

      {/* Technical Skills */}
      <section>
        <h3 className="text-lg font-semibold border-b pb-1 mb-3">Technical Skills</h3>
